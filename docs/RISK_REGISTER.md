...
| Risk | Impact | Control | Release evidence |
| --- | --- | --- | --- |
| Academic requirement/articulation overstated | Student trust and planning harm | Source metadata, verification states, no uncertain auto-credit | Data coverage tests and evidence UI |
| Route violates prerequisites or units | Core product failure | Deterministic validator owns eligibility | Invalid fixture plus zero-violation test |
