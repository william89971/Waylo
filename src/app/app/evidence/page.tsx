...
export default function EvidencePage() {
  ...
  return (
    <div className="production-page evidence-page fade-in">
      ...
      {sources.length ? (
        ...
        <div className="empty-state">
          <strong>No evidence items yet</strong>
          <p>Generate a plan first, then return here to inspect the sources behind each recommendation.</p>
        </div>
      )}
      <div className="evidence-disclaimer">
        <strong>Important limitation</strong>
        <p>
          Waylo validates internal prerequisite order and scheduling against its reviewed dataset. Exact
          COC-to-UCSD articulations still require confirmation in the applicable ASSIST agreement or with a
          counselor where marked.
        </p>
      </div>
    </div>
  );
